...
// Returns |true| if the given |area_code| is on the OFAC sanctioned list,
// otherwise |false|. |area_code| supports UN M49 area codes. See
// https://en.wikipedia.org/wiki/UN_M49.
//
// NOTE: Sanctioning UN M49 area codes will also block all other countries that
// are part of the same area code.
bool IsUNM49AreaCodeOFACSanctioned(base::StringPiece area_code);
